...
def hello():
  ...
  examples['/picture/644305-20210315-143941.jpg'] = "Returns all host objects scanned March 2nd 2021"
  ...
  valid['/picture/<filename>'] = "Returns the specified picture if in database"
